...
#|   /   /__   /     /__   / _   /__)  /__/  / //     /__)  /  /    /     |
#|  /   /__   /__   /__   /__/  / (   /  /  / //     /__)  /__/    /      |
#|________________________________________________________________________|1.5.0

/*
TELEGRAM BOT PHP Library v1.5.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Version: 1.5.0.2
Last updated on 27/07/2022, 14:58:39 UTC
    ...
    */
    ...
    public function send_poll($chat_id, $question, $options, $is_anonymous = true, $type = "regular", $multiple_answers = false, $correct_option_id = "", $explanation = "", $parse_mode = "", $explanation_entities = [], $open_period = "", $close_date = "", $is_closed = false, $silent = false, $protected = false, $reply_to = "", $force_reply = false, $reply_markup = []) {
        ...
        */
        ...
        $url = $this->URL .
            ...
            "&explanation_entities=" . json_encode($explanation_entities) .
    ...
    public function delete_commands($scope = "", $language_code = "") {
        ...
        */
        ...
        $url = $this->URL .
            "deleteMyCommands?scope=" . json_encode($scope) .
            "&language_code=" . $language_code;
    ...
    public function get_commands($scope = "", $language_code = "") {
        ...
        */
        ...
        $url = $this->URL .
            "getMyCommands?scope=" . json_encode($scope) .
            "&language_code=" . $language_code;
    ...
    public function answer_inline_query($inline_query_id, $results, $cache_time = 300, $is_personal = false, $next_offset = "", $switch_pm_text = "", $switch_pm_parameter = "") {
        ...
        */
        ...
        // if ($cache_time) $url .= "&cache_time=" . $cache_time;
        // if ($is_personal) $url .= "&is_personal=" . $is_personal;
        // if ($next_offset) $url .= "&next_offset=" . $next_offset;
        // if ($switch_pm_text) $url .= "&switch_pm_text=" . $switch_pm_text;
        // if ($switch_pm_parameter) $url .= "&switch_pm_parameter=" . $switch_pm_parameter;
