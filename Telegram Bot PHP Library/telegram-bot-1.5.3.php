...
#|   /    /__   /     /__   / _   /__)  /__/  // /     /__)  /  /   /      |
#|  /    /__   /__   /__   /__/  / (   /  /  // /     /__)  /__/   /       |
#|_________________________________________________________________________|1.5.3

/*
TELEGRAM BOT PHP Library v1.5.3
````````````````````````````````
...
class Bot {
    ...
    */
    ...
    public function send_message($chat_id, $message, $parse_mode = "", $entities = [], $no_preview = false, $silent = false, $protected = false, $reply_to = "", $force_reply = false, $reply_markup = []) {
        /*
    ...
    public function send_chat_action($chat_id, $action, $message_thread_id = "") {
        /*
            $chat_id: `int` OR `str`<Channel username>
    ...
    public function restrict_member($chat_id, $user_id, $permissions, $use_independent_chat_permissions = false, $until_date = "") {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $user_id: `int`
            $permissions: :method:`ChatPermissions.create()`
            $use_independent_chat_permissions: Optional[`bool`] Default: false
            $until_date: Optional[`int`<UNIX time>] Note: less than 30s or more than 366d are considered to be banned forever
        */
    ...
    public function promote_member($chat_id, $user_id, $is_anonymous = false, $can_manage_chat = false, $can_post_messages = false, $can_edit_messages = false, $can_delete_messages = false, $can_manage_video_chats = false, $can_restrict_members = false, $can_promote_members = false, $can_change_info = false, $can_invite_users = false, $can_pin_messages = false, $can_manage_topics = false) {
        /*
            ...
            $can_manage_topics: Optional[`bool`] Default: false
        */
    ...
    public function set_chat_permissions($chat_id, $permissions, $use_independent_chat_permissions = false) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $permissions: :method:`ChatPermissions.create()`
            $use_independent_chat_permissions: Optional[`bool`] Default: false
    ...
    public function get_forum_topic_icon_stickers() {
        /*
            No parameter needed.
        */
        ...
        $r = $this->request($url);
        return $r ? ($r["ok"] ? classify($r["result"], "Sticker") : new Err($r)) : false;
    }

    public function create_forum_topic($chat_id, $name, $icon_color = "", $icon_custom_emoji_id = "") {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $name: `str` 1-128 characters
            $icon_color: Optional[`int`[7322096 (0x6FB9F0) | 16766590 (0xFFD67E) | 13338331 (0xCB86DB) | 9367192 (0x8EEE98) | 16749490 (0xFF93B2) | 16478047 (0xFB6F5F)]] in RGB format.
            $icon_custom_emoji_id: Optional[`str`]
        */

        $url = $this->URL .
            "createForumTopic?chat_id=" . $chat_id .
            "&name=" . $name .
            "&icon_color=" . $icon_color .
            "&icon_custom_emoji_id=" . $icon_custom_emoji_id;

        $r = $this->request($url);
        return $r ? ($r["ok"] ? new ForumTopic($r["result"]) : new Err($r)) : false;
    }

    public function edit_forum_topic($chat_id, $message_thread_id, $name = "", $icon_custom_emoji_id = "") {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $message_thread_id: `int`
            $name: Optional[`str`] 0-128 characters
            $icon_custom_emoji_id: Optional[`str`]
        */

        $url = $this->URL .
            "editForumTopic?chat_id=" . $chat_id .
            "&message_thread_id=" . $message_thread_id .
            "&name=" . $name .
            "&icon_custom_emoji_id=" . $icon_custom_emoji_id;
    ...
    public function close_forum_topic($chat_id, $message_thread_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $message_thread_id: `int`
        */
        ...
        $url = $this->URL .
            "closeForumTopic?chat_id=" . $chat_id .
            "&message_thread_id=" . $message_thread_id;
    ...
    public function reopen_forum_topic($chat_id, $message_thread_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $message_thread_id: `int`
        */
        ...
        $url = $this->URL .
            "reopenForumTopic?chat_id=" . $chat_id .
            "&message_thread_id=" . $message_thread_id;
    ...
    public function delete_forum_topic($chat_id, $message_thread_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $message_thread_id: `int`
        */
        ...
        $url = $this->URL .
            "deleteForumTopic?chat_id=" . $chat_id .
            "&message_thread_id=" . $message_thread_id;
    ...
    public function unpin_all_forum_topic_messages($chat_id, $message_thread_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $message_thread_id: `int`
        */
        ...
        $url = $this->URL .
            "unpinAllForumTopicMessages?chat_id=" . $chat_id .
            "&message_thread_id=" . $message_thread_id;
    ...
    public function edit_general_forum_topic($chat_id, $name) {
        /*
            $chat_id: `int` OR `str`<Channel username>
            $name: `str` 1-128 characters
        */
        ...
        $url = $this->URL .
            "editGeneralForumTopic?chat_id=" . $chat_id .
            "&name=" . $name;
    ...
    public function close_general_forum_topic($chat_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
        */

        $url = $this->URL .
            "closeGeneralForumTopic?chat_id" . $chat_id;

        $r = $this->request($url);
        return $r ? ($r["ok"] ? $r["result"] : new Err($r)) : false;
    }

    public function reopen_general_forum_topic($chat_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
        */

        $url = $this->URL .
            "reopenGeneralForumTopic?chat_id=" . $chat_id;

        $r = $this->request($url);
        return $r ? ($r["ok"] ? $r["result"] : new Err($r)) : false;
    }

    public function hide_general_forum_topic($chat_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
        */

        $url = $this->URL .
            "hideGeneralForumTopic?chat_id=" . $chat_id;

        $r = $this->request($url);
        return $r ? ($r["ok"] ? $r["result"] : new Err($r)) : false;
    }

    public function unhide_general_forum_topic($chat_id) {
        /*
            $chat_id: `int` OR `str`<Channel username>
        */

        $url = $this->URL .
            "unhideGeneralForumTopic?chat_id=" . $chat_id;
    ...
    public function set_menu_button($chat_id = "", $menu_button = []) {
        /*
            ...
            $menu_button: Optional[:method:`MenuButtonCommands.create()` OR
                                           `MenuButtonDefault.create()`]
        */

        $url = $this->URL .
            "setChatMenuButton?chat_id=" . $chat_id;

        if ($menu_button) $url .= "&menu_button=" . json_encode($menu_button);
    ...
    public function set_default_admin_rights($rights = [], $for_channels = false) {
        ...
        */
        ...
        $url = $this->URL .
            "setMyDefaultAdministratorRights?for_channels=" . $for_channels;

        if ($rights) $url .= "&rights=" . json_encode($rights);
...
class Version {
    /*
        ...
        This object is not a part from Telegram Bot API.
        This object can be created for storing bot version information.
    */
...
class Author {
    /*
        ...
        This object is not a part from Telegram Bot API.
        This object can be created for storing bot author information.
    */
...
class Chat {
    ...
    */
    ...
    function __construct($chat) {
        ...
        $this->is_forum = array_key_exists("is_forum", $chat) ? $chat["is_forum"] : null;
        $this->photo = array_key_exists("photo", $chat) ? new ChatPhoto($chat["photo"]) : null;
        $this->active_usernames = array_key_exists("active_usernames", $chat) ? $chat["active_usernames"] : null;
        $this->emoji_status_custom_emoji_id = array_key_exists("emoji_status_custom_emoji_id", $chat) ? $chat["emoji_status_custom_emoji_id"] : null;
        ...
        $this->has_aggressive_anti_spam_enabled = array_key_exists("has_aggressive_anti_spam_enabled", $chat) ? $chat["has_aggressive_anti_spam_enabled"] : null;
        $this->has_hidden_members = array_key_exists("has_hidden_members", $chat) ? $chat["has_hidden_members"] : null;
...
class Message {
    ...
    */
    ...
    function __construct($message) {
        ...
        $this->thread_id = array_key_exists("message_thread_id ", $message) ? $message["message_thread_id "] : null;
        ...
        $this->is_topic_message = array_key_exists("is_topic_message", $message) ? $message["is_topic_message"] : null;
        ...
        $this->user_shared = array_key_exists("user_shared", $message) ? new UserShared($message["user_shared"]) : null;
        $this->chat_shared = array_key_exists("chat_shared", $message) ? new ChatShared($message["chat_shared"]) : null;
        ...
        $this->forum_topic_created = array_key_exists("forum_topic_created", $message) ? new ForumTopicCreated($message["forum_topic_created"]) : null;
        $this->forum_topic_edited = array_key_exists("forum_topic_edited", $message) ? new ForumTopicEdited($message["forum_topic_edited"]) : null;
        $this->forum_topic_closed = array_key_exists("forum_topic_closed", $message) ? new ForumTopicReopened($message["forum_topic_reopened"]) : null;
        $this->general_forum_topic_hidden = array_key_exists("general_forum_topic_hidden", $message) ? new GeneralForumTopicHidden($message["general_forum_topic_hidden"]) : null;
        $this->general_forum_topic_unhidden = array_key_exists("general_forum_topic_unhidden", $message) ? new GeneralForumTopicUnhidden($message["general_forum_topic_unhidden"]) : null;
...
class MessageEntity {
    ...
    */
    ...
    function __construct($message_entity) {
        ...
        $this->custom_emoji_id = array_key_exists("custom_emoji_id", $message_entity) ? $message_entity["custom_emoji_id"] : null;
    }

    public static function create($type, $offset, $length, $url = "", $language = "", $custom_emoji_id = "") {
        /*
            $type: `str`[mention | hashtag | cashtag | bot_command | url | email | phone_number | bold | italic | underline | strikethrough | spoiler | code | pre | text_link | text_mention | custom_emoji]
            $offset: `int`
            $length: `int`
            $url: Optional[`str`]
        ...
        */
        ...
        if ($custom_emoji_id) $message_entity["custom_emoji_id"] = $custom_emoji_id;
...
class ForumTopicCreated {
    ...
    */
    ...
    function __construct($forum_topic_created) {
        $this->name = $forum_topic_created["name"];
        $this->icon_color = $forum_topic_created["icon_color"];
        $this->icon_custom_emoji_id = array_key_exists("icon_custom_emoji_id", $forum_topic_created) ? $forum_topic_created["icon_custom_emoji_id"] : null;
    }
}
...
class ForumTopicClosed {
    ...
    */
    ...
    function __construct($forum_topic_closed) {
    }
}
...
class ForumTopicEdited {
    ...
    */
    ...
    function __construct($forum_topic_edited) {
        $this->name = array_key_exists("name", $forum_topic_edited) ? $forum_topic_edited["name"] : null;
        $this->icon_custom_emoji_id = array_key_exists("icon_custom_emoji_id", $forum_topic_edited) ? $forum_topic_edited["icon_custom_emoji_id"] : null;
    }
}
...
class ForumTopicReopened {
    ...
    */
    ...
    function __construct($forum_topic_reopened) {
    }
}
...
class GeneralForumTopicHidden {
    ...
    */
    ...
    function __construct($general_forum_topic_hidden) {
    }
}
...
class GeneralForumTopicUnhidden {
    ...
    */
    ...
    function __construct($general_forum_topic_unhidden) {
    }
}
...
class UserShared {
    ...
    */
    ...
    function __construct($user_shared) {
        $this->request_id = $user_shared["request_id"];
        $this->user_id = $user_shared["user_id"];
    }
}
...
class ChatShared {
    ...
    */
    ...
    function __construct($chat_chared) {
        $this->request_id = $chat_chared["request_id"];
        $this->chat_id = $chat_chared["chat_id"];
    }
}
...
class WriteAccessAllowed {
    ...
    */
    ...
    function __construct($write_access_allowed) {
    }
}
...
class KeyboardButton {
    ...
    */
    ...
    public static function create($text, $request_user = [], $request_chat = [], $request_contact = false, $request_location = false, $request_poll = []) {
        /*
            $text: `str`
            $request_user: Optional[:method:`KeyboardButtonRequestUser.create()`]
            $request_chat: Optional[:method:`KeyboardButtonRequestChat.create()`]
        ...
        */
        ...
        if ($request_user) $keyboard_button["request_user"] = $request_user;
        if ($request_chat) $keyboard_button["request_chat"] = $request_chat;
...
class KeyboardButtonRequestUser {
    ...
    */
    function __construct($keyboard_button_request_user) {
    }

    public static function create($request_id, $user_is_bot = "", $user_is_premium = "") {
        /*
            $request_id: `int` 32-bit unique identifier
        ...
        */
        ...
        if ($user_is_bot !== "") $keyboard_button_request_user["user_is_bot"] = $user_is_bot;
        if ($user_is_premium !== "") $keyboard_button_request_user["user_is_premium"] = $user_is_premium;
        return $keyboard_button_request_user;
    }
}
...
class KeyboardButtonRequestChat {
    ...
    */
    ...
    function __construct($keyboard_button_request_chat) {
    }

    public static function create($request_id, $chat_is_channel, $chat_is_forum = "", $chat_has_username = "", $chat_is_created = false, $user_administrator_rights = [], $bot_administrator_rights = [], $bot_is_member = false) {
        /*
            $request_id: `int` 32-bit unique identifier
            $chat_is_channel: `bool`
            $chat_is_forum: Optional[`bool`]
            $chat_has_username: Optional[`bool`]
            $chat_is_created: Optional[`bool`] Default: false
            $user_administrator_rights: Optional[:method:`ChatAdministratorRights.create()`]
            $bot_administrator_rights: Optional[:method:`ChatAdministratorRights.create()`]
            $bot_is_member: Optional[`bool`] Default: false
        */
        ...
        if ($chat_is_forum !== "") $keyboard_button_request_chat["chat_is_forum"] = $chat_is_forum;
        if ($chat_has_username !== "") $keyboard_button_request_chat["chat_has_username"] = $chat_has_username;
        if ($chat_is_created) $keyboard_button_request_chat["chat_is_created"] = $chat_is_created;
        if ($user_administrator_rights) $keyboard_button_request_chat["user_administrator_rights"] = $user_administrator_rights;
        if ($bot_administrator_rights) $keyboard_button_request_chat["bot_administrator_rights"] = $bot_administrator_rights;
        if ($bot_is_member) $keyboard_button_request_chat["bot_is_member"] = $bot_is_member;
...
class ChatAdministratorRights {
    ...
    */
    ...
    function __construct($chat_administrator_rights) {
        ...
        $this->can_manage_topics = array_key_exists("can_manage_topics", $chat_administrator_rights) ? $chat_administrator_rights["can_manage_topics"] : null;
    }

    public static function create($is_anonymous, $can_manage_chat, $can_delete_messages, $can_manage_video_chats, $can_restrict_members, $can_promote_members, $can_change_info, $can_invite_users, $can_post_messages = false, $can_edit_messages = false, $can_pin_messages = false, $can_manage_topics = false) {
        /*
        ...
        */
        ...
        if ($can_manage_topics) $chat_administrator_rights["can_manage_topics"];
...
class ChatMember {
    ...
    */
    ...
    public $status;
    public final const STATUS_OWNER = "creator";
    public final const STATUS_ADMINISTRATOR = "administrator";
    public final const STATUS_MEMBER = "member";
    public final const STATUS_RESTRICTED = "restricted";
    public final const STATUS_LEFT = "left";
    public final const STATUS_BANNED = "kicked";
    public $user;
    public $is_anonymous;
    public $custom_title;
    public $is_member;
    ...
    function __construct($chat_member) {
        ...
        $this->can_manage_topics = array_key_exists("can_manage_topics", $chat_member) ? $chat_member["can_manage_topics"] : null;
        $this->can_send_messages = array_key_exists("can_send_messages", $chat_member) ? $chat_member["can_send_messages"] : null;
        $this->can_send_audios = array_key_exists("can_send_audios", $chat_member) ? $chat_member["can_send_audios"] : null;
        $this->can_send_documents = array_key_exists("can_send_documents", $chat_member) ? $chat_member["can_send_documents"] : null;
        $this->can_send_photos = array_key_exists("can_send_photos", $chat_member) ? $chat_member["can_send_photos"] : null;
        $this->can_send_videos = array_key_exists("can_send_videos", $chat_member) ? $chat_member["can_send_videos"] : null;
        $this->can_send_video_notes = array_key_exists("can_send_video_notes", $chat_member) ? $chat_member["can_send_video_notes"] : null;
        $this->can_send_voice_notes = array_key_exists("can_send_voice_notes", $chat_member) ? $chat_member["can_send_voice_notes"] : null;
...
class ChatJoinRequest {
    ...
    */
    ...
    function __construct($chat_join_request) {
        ...
        $this->user_chat_id = $chat_join_request["user_chat_id"];
...
class ChatPermissions {
    ...
    */
    ...
    function __construct($chat_permissions) {
        ...
        $this->can_send_audios = array_key_exists("can_send_audios", $chat_permissions) ? $chat_permissions["can_send_audios"] : null;
        $this->can_send_documents = array_key_exists("can_send_documents", $chat_permissions) ? $chat_permissions["can_send_documents"] : null;
        $this->can_send_photos = array_key_exists("can_send_photos", $chat_permissions) ? $chat_permissions["can_send_photos"] : null;
        $this->can_send_videos = array_key_exists("can_send_videos", $chat_permissions) ? $chat_permissions["can_send_videos"] : null;
        $this->can_send_video_notes = array_key_exists("can_send_video_notes", $chat_permissions) ? $chat_permissions["can_send_video_notes"] : null;
        $this->can_send_voice_notes = array_key_exists("can_send_voice_notes", $chat_permissions) ? $chat_permissions["can_send_voice_notes"] : null;
        ...
        $this->can_manage_topics = array_key_exists("can_manage_topics", $chat_permissions) ? $chat_permissions["can_manage_topics"] : null;
    }

    public static function create($can_send_messages = false, $can_send_audios = false, $can_send_documents = false, $can_send_photos = false, $can_send_videos = false, $can_send_video_notes = false, $can_send_voice_notes = false, $can_send_polls = false, $can_send_other_messages = false, $can_add_web_page_previews = false, $can_change_info = false, $can_invite_users = false, $can_pin_messages = false, $can_manage_topics = false) {
        /*
            $can_send_messages: Optional[`bool`] Default: false
            $can_send_audios: Optional[`bool`] Default: false
            $can_send_documents: Optional[`bool`] Default: false
            $can_send_photos: Optional[`bool`] Default: false
            $can_send_videos: Optional[`bool`] Default: false
            $can_send_video_notes: Optional[`bool`] Default: false
            $can_send_voice_notes: Optional[`bool`] Default: false
        ...
        */
        ...
        if ($can_send_audios) $chat_permissions["can_send_audios"] = $can_send_audios;
        if ($can_send_documents) $chat_permissions["can_send_documents"] = $can_send_documents;
        if ($can_send_photos) $chat_permissions["can_send_photos"] = $can_send_photos;
        if ($can_send_videos) $chat_permissions["can_send_videos"] = $can_send_videos;
        if ($can_send_video_notes) $chat_permissions["can_send_video_notes"] = $can_send_video_notes;
        if ($can_send_voice_notes) $chat_permissions["can_send_voice_notes"] = $can_send_voice_notes;
        ...
        if ($can_manage_topics) $chat_permissions["can_manage_topics"] = $can_manage_topics;
...
class ForumTopic {
    ...
    */
    ...
    function __construct($forum_topic) {
        $this->message_thread_id = $forum_topic["message_thread_id"];
        $this->name = $forum_topic["name"];
        $this->icon_color = $forum_topic["icon_color"];
        $this->icon_custom_emoji_id = array_key_exists("icon_custom_emoji_id", $forum_topic) ? $forum_topic["icon_custom_emoji_id"] : null;
    }
}
...
class Sticker {
    ...
    */
    ...
    function __construct($sticker) {
        ...
        $this->custom_emoji_id = array_key_exists("custom_emoji_id", $sticker) ? $sticker["custom_emoji_id"] : null;
...
class StickerSet {
    ...
    */
    ...
    function __construct($sticker_set) {
        ...
        $this->sticker_type = $sticker_set["sticker_type"];
